...
//               <p className="text-justify">The conference is non-residential and delegates are kindly requested to make their own arrangement for accommodation. If you have any query, please drop a mail to <a href="mailto:icncda.congress@gmail.com" className="text-blue-600 hover:underline">icncda.congress@gmail.com</a>. All participants and authors abide by the organization's guidelines.</p>
//             </div>
//           </section>
//         </div>
//       </div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full border-collapse">
                <thead>
                  <tr className="bg-[#f9f5e9]">
                    <th className="border border-gray-300 px-4 py-2 text-left">Category</th>
                    <th className="border border-gray-300 px-4 py-2 text-left">EARLY REGISTRATION (Before 20th April 2026)</th>
                    <th className="border border-gray-300 px-4 py-2 text-left">LATE REGISTRATION (After 20th April 2026)</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
